...
<html>
    ...
    <body class="blackBack">
        ...
        <div class="contentDiv2 container-fluid">
            <div class="contentDiv2 twoCol topMargin textback">
                ...
                <div id="basicButtons">
                    ...
                    <div id="tradeImgForCss">
                        <img src="${pageContext.request.contextPath}/img/whitetest.jpg" alt="BuddhaWorks" width="100" height="100" class="morph">
                    </div>
